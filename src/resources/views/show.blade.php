...
<div class="card">
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-9">{{$courier['name']}}</div>
    </div>
    <div class="row">
      <div class="col">송장번호</div>
      <div class="col-9">{{$invoicenumber}}</div>
    </div>
    <div class="row">
      <div class="col"></div>
      <div class="col-9"><a class="btn btn-info btn-sm" href="{{$courier['query_url']}}" target="_new">직접조회</a></div>
    </div>
  </div>
  <div class="card-header">
    <span>진행상태</span>
